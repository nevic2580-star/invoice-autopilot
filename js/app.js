...
const App = (() => {
  ...
  function navigateTo(page,eid=null) {
    ...
    switch(page){
      ...
      case 'register':main.innerHTML=InvoiceManager.renderRegisterPage(currentLang,eid);setTimeout(()=>{InvoiceManager.onCategoryChange();InvoiceManager.calcDifference();InvoiceManager.checkDuplicate();},80);break;

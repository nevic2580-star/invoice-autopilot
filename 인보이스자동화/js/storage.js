...
const Storage = (() => {
  ...
  function getInvoices() { 
    let invoices = getAll(KEYS.invoices);
    if (typeof Auth !== 'undefined' && Auth.getCurrentUser) {
      const u = Auth.getCurrentUser();
      if (u && u.role === 'vendor' && u.vendorId) {
        invoices = invoices.filter(inv => inv.vendorId === u.vendorId);
      }
    }
    return invoices;
  }
  ...
  function generateInvoiceId() {
    ...
    const allInvoices = getAll(KEYS.invoices);
    const yearInvoices = allInvoices.filter(i => i.id && i.id.startsWith(`COV-${year}`));
  ...
  function seedDemoData(force = false) {
    if (!force && localStorage.getItem(KEYS.initialized)) return false;
    ...
    const ports = [
      { id:'P101', country:'KR', countryName:'대한민국 (South Korea)', name:'Busan', nameKo:'부산' },
      { id:'P102', country:'KR', countryName:'대한민국 (South Korea)', name:'Incheon', nameKo:'인천' },
      { id:'P103', country:'KR', countryName:'대한민국 (South Korea)', name:'Ulsan', nameKo:'울산' },
      { id:'P104', country:'KR', countryName:'대한민국 (South Korea)', name:'Gwangyang', nameKo:'광양' },
      { id:'P105', country:'KR', countryName:'대한민국 (South Korea)', name:'Pyeongtaek', nameKo:'평택' },
      { id:'P106', country:'KR', countryName:'대한민국 (South Korea)', name:'Pohang', nameKo:'포항' },
      { id:'P107', country:'KR', countryName:'대한민국 (South Korea)', name:'Mokpo', nameKo:'목포' },

      { id:'P111', country:'CN', countryName:'중국 (China)', name:'Shanghai', nameKo:'상하이' },
      { id:'P112', country:'CN', countryName:'중국 (China)', name:'Ningbo-Zhoushan', nameKo:'닝보-저우산' },
      { id:'P113', country:'CN', countryName:'중국 (China)', name:'Shenzhen', nameKo:'선전' },
      { id:'P114', country:'CN', countryName:'중국 (China)', name:'Qingdao', nameKo:'칭다오' },
      { id:'P115', country:'CN', countryName:'중국 (China)', name:'Tianjin', nameKo:'텐진' },
      { id:'P116', country:'CN', countryName:'중국 (China)', name:'Guangzhou', nameKo:'광저우' },
      { id:'P117', country:'CN', countryName:'중국 (China)', name:'Dalian', nameKo:'다롄' },
      { id:'P118', country:'CN', countryName:'중국 (China)', name:'Xiamen', nameKo:'샤먼' },

      { id:'P121', country:'JP', countryName:'일본 (Japan)', name:'Tokyo', nameKo:'도쿄' },
      { id:'P122', country:'JP', countryName:'일본 (Japan)', name:'Yokohama', nameKo:'요코하마' },
      { id:'P123', country:'JP', countryName:'일본 (Japan)', name:'Nagoya', nameKo:'나고야' },
      { id:'P124', country:'JP', countryName:'일본 (Japan)', name:'Osaka', nameKo:'오사카' },
      { id:'P125', country:'JP', countryName:'일본 (Japan)', name:'Kobe', nameKo:'고베' },
      { id:'P126', country:'JP', countryName:'일본 (Japan)', name:'Chiba', nameKo:'치바' },
      { id:'P127', country:'JP', countryName:'일본 (Japan)', name:'Moji', nameKo:'모지' },
      { id:'P128', country:'JP', countryName:'일본 (Japan)', name:'Hakata', nameKo:'하카타' },

      { id:'P131', country:'SG', countryName:'싱가포르 (Singapore)', name:'Singapore', nameKo:'싱가포르' },
      { id:'P132', country:'SG', countryName:'싱가포르 (Singapore)', name:'Jurong', nameKo:'주롱' },

      { id:'P141', country:'VN', countryName:'베트남 (Vietnam)', name:'Hai Phong', nameKo:'하이퐁' },
      { id:'P142', country:'VN', countryName:'베트남 (Vietnam)', name:'Ho Chi Minh', nameKo:'호치민' },
      { id:'P143', country:'VN', countryName:'베트남 (Vietnam)', name:'Da Nang', nameKo:'다낭' },
      { id:'P144', country:'VN', countryName:'베트남 (Vietnam)', name:'Cai Mep', nameKo:'카이멥' },
      { id:'P145', country:'VN', countryName:'베트남 (Vietnam)', name:'Vung Tau', nameKo:'붕따우' },

      { id:'P151', country:'MY', countryName:'말레이시아 (Malaysia)', name:'Port Klang', nameKo:'포트클랑' },
      { id:'P152', country:'MY', countryName:'말레이시아 (Malaysia)', name:'Tanjung Pelepas', nameKo:'탄중 펠레파스' },
      { id:'P153', country:'MY', countryName:'말레이시아 (Malaysia)', name:'Penang', nameKo:'페낭' },
      { id:'P154', country:'MY', countryName:'말레이시아 (Malaysia)', name:'Johor', nameKo:'조호르' },

      { id:'P161', country:'ID', countryName:'인도네시아 (Indonesia)', name:'Tanjung Priok', nameKo:'자카르타' },
      { id:'P162', country:'ID', countryName:'인도네시아 (Indonesia)', name:'Tanjung Perak', nameKo:'수라바야' },
      { id:'P163', country:'ID', countryName:'인도네시아 (Indonesia)', name:'Belawan', nameKo:'벨라완' },
      { id:'P164', country:'ID', countryName:'인도네시아 (Indonesia)', name:'Semarang', nameKo:'세마랑' },

      { id:'P171', country:'IN', countryName:'인도 (India)', name:'Mundra', nameKo:'문드라' },
      { id:'P172', country:'IN', countryName:'인도 (India)', name:'Nhava Sheva', nameKo:'나바셰바' },
      { id:'P173', country:'IN', countryName:'인도 (India)', name:'Chennai', nameKo:'첸나이' },
      { id:'P174', country:'IN', countryName:'인도 (India)', name:'Kolkata', nameKo:'콜카타' },
      { id:'P175', country:'IN', countryName:'인도 (India)', name:'Visakhapatnam', nameKo:'비샤카파트남' },

      { id:'P181', country:'TW', countryName:'대만 (Taiwan)', name:'Kaohsiung', nameKo:'카오슝' },
      { id:'P182', country:'TW', countryName:'대만 (Taiwan)', name:'Keelung', nameKo:'키륭' },
      { id:'P183', country:'TW', countryName:'대만 (Taiwan)', name:'Taichung', nameKo:'타이중' },

      { id:'P191', country:'TH', countryName:'태국 (Thailand)', name:'Laem Chabang', nameKo:'람차방' },
      { id:'P192', country:'TH', countryName:'태국 (Thailand)', name:'Bangkok', nameKo:'방콕' },

      { id:'P201', country:'AE', countryName:'아랍에미리트 (UAE)', name:'Jebel Ali', nameKo:'제벨알리' },
      { id:'P202', country:'AE', countryName:'아랍에미리트 (UAE)', name:'Khalifa Port', nameKo:'아부다비' },
      { id:'P203', country:'AE', countryName:'아랍에미리트 (UAE)', name:'Sharjah', nameKo:'샤르자' },
      { id:'P204', country:'AE', countryName:'아랍에미리트 (UAE)', name:'Fujairah', nameKo:'푸자이라' },

      { id:'P211', country:'SA', countryName:'사우디아라비아 (Saudi Arabia)', name:'Jeddah', nameKo:'제다' },
      { id:'P212', country:'SA', countryName:'사우디아라비아 (Saudi Arabia)', name:'King Abdullah', nameKo:'킹 압둘라' },
      { id:'P213', country:'SA', countryName:'사우디아라비아 (Saudi Arabia)', name:'Dammam', nameKo:'담맘' },

      { id:'P221', country:'EG', countryName:'이집트 (Egypt)', name:'Port Said', nameKo:'포트사이드' },
      { id:'P222', country:'EG', countryName:'이집트 (Egypt)', name:'Damietta', nameKo:'다미에타' },
      { id:'P223', country:'EG', countryName:'이집트 (Egypt)', name:'Alexandria', nameKo:'알렉산드리아' },
      { id:'P224', country:'EG', countryName:'이집트 (Egypt)', name:'Suez', nameKo:'수에즈' },

      { id:'P231', country:'ZA', countryName:'남아공 (South Africa)', name:'Durban', nameKo:'더반' },
      { id:'P232', country:'ZA', countryName:'남아공 (South Africa)', name:'Cape Town', nameKo:'케이프타운' },
      { id:'P233', country:'ZA', countryName:'남아공 (South Africa)', name:'Ngqura', nameKo:'은쿠라' },

      { id:'P241', country:'MA', countryName:'모로코 (Morocco)', name:'Tanger Med', nameKo:'탕헤르 메드' },
      { id:'P242', country:'MA', countryName:'모로코 (Morocco)', name:'Casablanca', nameKo:'카사블랑카' },

      { id:'P301', country:'NL', countryName:'네덜란드 (Netherlands)', name:'Rotterdam', nameKo:'로테르담' },
      { id:'P302', country:'NL', countryName:'네덜란드 (Netherlands)', name:'Amsterdam', nameKo:'암스테르담' },

      { id:'P311', country:'DE', countryName:'독일 (Germany)', name:'Hamburg', nameKo:'함부르크' },
      { id:'P312', country:'DE', countryName:'독일 (Germany)', name:'Bremerhaven', nameKo:'브레머하펜' },
      { id:'P313', country:'DE', countryName:'독일 (Germany)', name:'Wilhelmshaven', nameKo:'빌헬름스하펜' },

      { id:'P321', country:'BE', countryName:'벨기에 (Belgium)', name:'Antwerp-Bruges', nameKo:'앤트워프-브뤼헤' },

      { id:'P331', country:'GB', countryName:'영국 (UK)', name:'Felixstowe', nameKo:'펠릭스토우' },
      { id:'P332', country:'GB', countryName:'영국 (UK)', name:'Southampton', nameKo:'사우샘프턴' },
      { id:'P333', country:'GB', countryName:'영국 (UK)', name:'London Gateway', nameKo:'런던 게이트웨이' },

      { id:'P341', country:'FR', countryName:'프랑스 (France)', name:'Le Havre', nameKo:'르아브르' },
      { id:'P342', country:'FR', countryName:'프랑스 (France)', name:'Marseille', nameKo:'마르세유' },

      { id:'P351', country:'IT', countryName:'이탈리아 (Italy)', name:'Genoa', nameKo:'제노바' },
      { id:'P352', country:'IT', countryName:'이탈리아 (Italy)', name:'Trieste', nameKo:'트리에스테' },
      { id:'P353', country:'IT', countryName:'이탈리아 (Italy)', name:'La Spezia', nameKo:'라 스페치아' },

      { id:'P361', country:'ES', countryName:'스페인 (Spain)', name:'Valencia', nameKo:'발렌시아' },
      { id:'P362', country:'ES', countryName:'스페인 (Spain)', name:'Algeciras', nameKo:'알헤시라스' },
      { id:'P363', country:'ES', countryName:'스페인 (Spain)', name:'Barcelona', nameKo:'바르셀로나' },

      { id:'P371', country:'GR', countryName:'그리스 (Greece)', name:'Piraeus', nameKo:'피레우스' },

      { id:'P381', country:'TR', countryName:'튀르키예 (Turkey)', name:'Ambarli', nameKo:'암바를리' },
      { id:'P382', country:'TR', countryName:'튀르키예 (Turkey)', name:'Kocaeli', nameKo:'코카엘리' },
      { id:'P383', country:'TR', countryName:'튀르키예 (Turkey)', name:'Mersin', nameKo:'메르신' },

      { id:'P401', country:'US', countryName:'미국 (USA)', name:'Los Angeles', nameKo:'로스앤젤레스' },
      { id:'P402', country:'US', countryName:'미국 (USA)', name:'Long Beach', nameKo:'롱비치' },
      { id:'P403', country:'US', countryName:'미국 (USA)', name:'New York/New Jersey', nameKo:'뉴욕/뉴저지' },
      { id:'P404', country:'US', countryName:'미국 (USA)', name:'Savannah', nameKo:'사바나' },
      { id:'P405', country:'US', countryName:'미국 (USA)', name:'Houston', nameKo:'휴스턴' },
      { id:'P406', country:'US', countryName:'미국 (USA)', name:'Seattle', nameKo:'시애틀' },

      { id:'P411', country:'CA', countryName:'캐나다 (Canada)', name:'Vancouver', nameKo:'밴쿠버' },
      { id:'P412', country:'CA', countryName:'캐나다 (Canada)', name:'Montreal', nameKo:'몬트리올' },
      { id:'P413', country:'CA', countryName:'캐나다 (Canada)', name:'Prince Rupert', nameKo:'프린스 루퍼트' },

      { id:'P421', country:'PA', countryName:'파나마 (Panama)', name:'Balboa', nameKo:'발보아' },
      { id:'P422', country:'PA', countryName:'파나마 (Panama)', name:'Cristobal', nameKo:'크리스토발' },
      { id:'P423', country:'PA', countryName:'파나마 (Panama)', name:'Colon', nameKo:'콜론' },

      { id:'P431', country:'BR', countryName:'브라질 (Brazil)', name:'Santos', nameKo:'산토스' },
      { id:'P432', country:'BR', countryName:'브라질 (Brazil)', name:'Paranagua', nameKo:'파라나구아' },
      { id:'P433', country:'BR', countryName:'브라질 (Brazil)', name:'Rio Grande', nameKo:'리오그란데' },

      { id:'P441', country:'MX', countryName:'멕시코 (Mexico)', name:'Manzanillo', nameKo:'만사니요' },
      { id:'P442', country:'MX', countryName:'멕시코 (Mexico)', name:'Lazaro Cardenas', nameKo:'라자로 카르데나스' },

      { id:'P451', country:'AU', countryName:'호주 (Australia)', name:'Melbourne', nameKo:'멜버른' },
      { id:'P452', country:'AU', countryName:'호주 (Australia)', name:'Sydney', nameKo:'시드니' },
      { id:'P453', country:'AU', countryName:'호주 (Australia)', name:'Brisbane', nameKo:'브리즈번' },
      { id:'P454', country:'AU', countryName:'호주 (Australia)', name:'Fremantle', nameKo:'퍼스' }
    ];
...
// Auto-migrate to new 54 vessels data, 218 vendors & global ports
if(Storage.getVessels().length < 10 || Storage.getPorts().length < 90 || !Storage.getUsers() || Storage.getUsers().length === 0) { 
  // Instead of completely resetting and deleting invoices, just re-seed ports and vendors if needed.
  if (Storage.getPorts().length < 90) {
    localStorage.removeItem('inv_ports');
    Storage.seedDemoData(true); // This will re-seed empty buckets including ports
  } else {
    Storage.resetData(); 
  }
}
